                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('judul') is-invalid @enderror" type="text" id="judul"
                            name="judul" required placeholder="Tuliskan judul informasi desa..." value="{{ old('judul') }}">
                        @error('judul')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('konten') is-invalid @enderror" id="konten"
                            name="konten" rows="12" required placeholder="Tuliskan isi pengumuman atau berita secara lengkap di sini...">{{ old('konten') }}</textarea>
                        @error('konten')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('tanggal_publish') is-invalid @enderror" type="date" id="tanggal_publish"
                            name="tanggal_publish" required value="{{ old('tanggal_publish', now()->toDateString()) }}">
                    ...
                    <div class="mb-3">
                        <label for="file_gambar" class="form-label">Gambar Cover / Unggahan (Opsional)</label>
                    ...
                    <div class="card border border-dashed p-2 text-center" style="min-height: 180px; display: flex; align-items: center; justify-content: center; background-color: #f8f9fa; border-radius: 8px;">
                        <div id="preview-placeholder">
                            <i class="bi bi-image text-muted fs-1"></i>
                            <p class="small text-muted mb-0">Pratinjau gambar akan muncul di sini</p>
                        </div>
                        <img id="image-preview" src="#" alt="Pratinjau Gambar" class="img-fluid d-none" style="max-height: 200px; object-fit: contain; border-radius: 6px;">
                    </div>
                </div>
            </div>
