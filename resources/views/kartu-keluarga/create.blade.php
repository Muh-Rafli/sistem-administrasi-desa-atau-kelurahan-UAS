<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('kartu-keluarga.store') }}" method="post" class="form">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('no_kk') is-invalid @enderror" type="text" id="no_kk"
                            name="no_kk" required data-parsley-type="digits" data-parsley-length="[16, 16]" value="{{ old('no_kk') }}">
                        @error('no_kk')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('rt') is-invalid @enderror" type="text" id="rt"
                                name="rt" required maxlength="10" value="{{ old('rt') }}">
                            @error('rt')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('rw') is-invalid @enderror" type="text" id="rw"
                                name="rw" required maxlength="10" value="{{ old('rw') }}">
                            @error('rw')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('desa_kelurahan') is-invalid @enderror" type="text" id="desa_kelurahan"
                            name="desa_kelurahan" required value="{{ old('desa_kelurahan') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('kecamatan') is-invalid @enderror" type="text" id="kecamatan"
                            name="kecamatan" required value="{{ old('kecamatan') }}">
                        @error('kecamatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('kabupaten_kota') is-invalid @enderror" type="text" id="kabupaten_kota"
                            name="kabupaten_kota" required value="{{ old('kabupaten_kota') }}">
