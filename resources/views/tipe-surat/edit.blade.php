<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <form action="{{ route('tipe-surat.update', $tipeSurat) }}" method="post" class="form">
            @csrf
            @method('put')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('kode_surat') is-invalid @enderror" type="text" id="kode_surat"
                            name="kode_surat" required placeholder="Contoh: SKD, SKU, SKTM" maxlength="20" value="{{ old('kode_surat', $tipeSurat->kode_surat) }}">
                        @error('kode_surat')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('nama_surat') is-invalid @enderror" type="text" id="nama_surat"
                            name="nama_surat" required placeholder="Contoh: Surat Keterangan Domisili" value="{{ old('nama_surat', $tipeSurat->nama_surat) }}">
                        @error('nama_surat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('template_konten') is-invalid @enderror" id="template_konten"
                            name="template_konten" rows="12" required placeholder="Tuliskan draf teks surat di sini...">{{ old('template_konten', $tipeSurat->template_konten) }}</textarea>
